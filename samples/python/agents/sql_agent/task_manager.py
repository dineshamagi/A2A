# agents/sql_agnt/task_manager.py

from typing import AsyncIterable
from common.types import (
    SendTaskRequest, TaskSendParams, Message, TaskStatus, Artifact, TextPart,
    TaskState, SendTaskResponse, InternalError, JSONRPCResponse, SendTaskStreamingRequest,
    SendTaskStreamingResponse, TaskArtifactUpdateEvent, TaskStatusUpdateEvent, Task,
    TaskIdParams, PushNotificationConfig, SetTaskPushNotificationRequest,
    SetTaskPushNotificationResponse, TaskPushNotificationConfig, TaskNotFoundError,
    InvalidParamsError,
)
from common.server.task_manager import InMemoryTaskManager
from agents.sql_agnt.agent import SQLAgent
...
class AgentTaskManager(InMemoryTaskManager):
    ...
    async def _run_streaming_agent(self, request: SendTaskStreamingRequest):
        ...
        try:
            logger.info("Calling agent.STREAM()")
